...
- (void) viewWillAppear:(BOOL)animated
{
    ...
    self.restaurant = [self.restaurant initWithName:@"cantina" andPictureString:@"cinema.png" andCoordinates:point andType:@"italiana" andDetails:@"bom ba garai" andTables:nil andId:@"funfou porra" andOwner:@"Bruno" andPlaceLocation:@"Zelandia,123"];
